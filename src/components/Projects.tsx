...
const projects = [
  {
    ...
    description: "Website for a cabin rental complex in Tanti, Córdoba, Argentina. Features a smart contact form that collects dates and guest count before opening WhatsApp, solving the problem of empty 'Hola' messages. Sanity CMS integration lets the owner update prices independently—essential with Argentine inflation.",
    stack: [
